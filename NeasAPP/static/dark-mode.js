...
// //ESTE ES EL CODIGO CON EL LOCALSTORAGE QUE ALMACENA INCLUSO AL RECARGAR LA PAGINA
//
// const body = document.querySelector('body');
// const sidebar = body.querySelector('.sidebar');
// const toggle = body.querySelector('.toggle');
...
//ESTE ES EL CODIGO EN EL SESSION STORAGE QUE AL RECARGAR LA PAGINA NO ALMACENA EL MODO OSCURO
...
// Función para guardar el estado del modo oscuro en el sessionStorage
const saveDarkModeState = (darkModeEnabled) => {
  sessionStorage.setItem('darkModeEnabled', darkModeEnabled);
};

// Función para cargar el estado del modo oscuro del sessionStorage
const loadDarkModeState = () => {
...
// Verificar si el modo oscuro está guardado en el sessionStorage y cargarlo al cargar la página
loadDarkModeState();
