    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tematica', models.CharField(choices=[('Gastronómico', 'Gastronomico'), ('Cultural', 'Cultural'), ('Historico', 'Historico'), ('Ocio', 'Ocio'), ('Naturalza', 'Naturaleza'), ('Religioso', 'Religioso')], max_length=100)),
                ...
                ('operador_tur', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='NeasAPP.operador_tur')),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('Admin', 'Admin'), ('Cliente', 'Cliente')], default='Cliente', max_length=100, unique=True)),
            ],
            options={
                'abstract': False,
            },
