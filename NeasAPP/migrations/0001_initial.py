    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen', models.CharField(default=None, max_length=500)),
                ('valoracion_media', models.FloatField(default=0.0, max_length=4)),
                ('ciudad', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='NeasAPP.ciudad')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('Admin', 'Admin'), ('Cliente', 'Cliente'), ('Operador', 'Operador')], default='Cliente', max_length=100, null=True, unique=None)),
            ],
            options={
                'abstract': False,
            },
